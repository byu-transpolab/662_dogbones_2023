...
To understand traffic needs for the interchange, the team created a existing conditions model.
...
Based on the collected data, an AM
peak of 7:15--8:15 AM, and an PM
peak of 4:30--5:30 PM
...
Ten model iterations of both AM
and PM
models were run.
