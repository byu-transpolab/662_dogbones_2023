...
The build model experiences decreases in vehicle delay for most traffic movemements for the AM and PM peak, but especially for the PM peak. 
There are a few movements where delays increase slightly in the Build model, but these are vastly overshadowed by the decreases in vehicle delay.
