...
Tables [-@tbl-final-am-los-comp] and [-@tbl-final-pm-los-comp] show the results build model in the AM and PM peak periods, compared with the no-build scenario model.
LOS was determined from the Highway Capacity Manual 7th edition [@hcm7].

```{r}
#| label: tbl-final-am-los-comp
...
@fig-final-tt compares average travel times from the build model with the existing model for both AM and PM peak periods.
