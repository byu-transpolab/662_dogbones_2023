...
This section will document the modeling of existing traffic conditions. These conditions were modeled to evaluate the current performance of the interchange. This section will outline the study parameters, model setup and results from the existing interchange analysis.
...
The VISSIM model was developed off the UDOT VISSIM template [@template] and is shown in @fig-vissim_existing_all. The template provided speed distributions and driver characteristics approved by the UDOT Traffic group.
